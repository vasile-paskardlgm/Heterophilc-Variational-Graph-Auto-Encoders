...
def preprocess(dataset_name:str='crocodile',normalization='sym',url:str='.\\',rm_selfloop=True,
    ...
    dataset_name:str,'chameleon'|'crocodile'|'squirrel'|'Cornell'|'Texas'|'Wisconsin'|'EN'|'DE'|'johnshopkins55'|'amherst41', 
        all datasets come from torch.geometric_datasets, depend on the paper '2020-Multi-scale Attributed Node Embedding' and
